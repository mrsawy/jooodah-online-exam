...
import { checkLogged, login } from "../../store/auth/authSlice";
...
function LoginForm() {
  ...
  const { checkIsDone, isError, isLoading, isSuccess, isLogged, loggingIsDone } = useSelector(
    (state) => state.auth
  );
